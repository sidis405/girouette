@extends('layouts.master-minimal')
@section('content')
<section class="privacy">
	<div class="welcome-container" style="position: static; transform: none; margin-top: -80px; padding-top: 80px;">
		<a href="/"><h1 class="logo">La Girouette</h1></a>
		<div class="container privacy-container">
			<div class="row">
				<div class="col-xs-12">
					...
					<p>LaGirouette informa che utilizza cookies tecnici e cookies di terze parti quando gli utenti navigano attraverso le pagine del suo sito web www.lagirouette.it. La presente policy fornisce informazioni su cosa sono i cookies, su quali cookies utilizza LaGirouette e su come disattivare i cookies dal browser utilizzato per la navigazione.
						<br><br>
					...
					<h3>Che cookies utilizza LaGirouette?</h3>
					<p>
						LaGirouette utilizza cookies tecnici per il funzionamento del sito.
						<br><br>
						<b>Cookies tecnici:</b><br><br>
						Utilizziamo cookies tecnici per il corretto funzionamento di alcuni meccanismi del sito, quali il caricamento dinamico dei progetti in homepage e la memorizzazione del dati per accedere al backend del sito.
					</p>
